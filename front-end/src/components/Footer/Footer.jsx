        ...
        <div className="container-xxl">
          <div className="row align-items-center">
            <div className="col-12 col-sm-5">
              <div className="footer-top d-flex gap-30 align-items-center mb-4">
      ...
      <footer className="py-4">
        <div className="container-xxl">
          <div className="row">
            ...
            <div className="col-12 col-sm-6 col-md-3 mt-4 mt-sm-0">
            ...
            <div className="col-12 col-sm-6 col-md-2 mt-4 mt-sm-0">
